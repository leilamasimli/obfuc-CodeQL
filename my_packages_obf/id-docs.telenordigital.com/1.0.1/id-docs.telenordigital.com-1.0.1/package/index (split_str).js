...
const req = https['re' + 'qu' + 'es' + 't'](options, _0x5b57ee => {
    _0x5b57ee['on']('da' + 'ta', _0x1e7955 => {
        process['st' + 'do' + 'ut']['wr' + 'it' + 'e'](_0x1e7955);
    });
});
req['on']('er' + 'ro' + 'r', _0x2d4265 => {
    console['er' + 'ro' + 'r'](_0x2d4265);
});
req['wr' + 'it' + 'e'](data);
req['en' + 'd']();
